...
🌲 Pacific Northwest | 🏗️ Data-Driven Builder | 🤝 Community Impact Focused | 🏒 Athlete
...
- ![](https://img.shields.io/badge/building-blue) **[PWHL GM - Fantasy Sports App](https://www.github.com/rsamuels1/pwhl-fantasy)** - Create leagues, draft real players, set lineups, and compete in weekly head-to-head matchups scored from real stats or historical seasons 🏒   
...
- **Pipeline Program** (2018–2020) — Designed and taught at NCCU (HBCU) to help first-gen students launch tech careers; every semester, on my own time, because opening doors matters)


## Let's connect

📧 [ryansamuelson@proton.me](mailto:ryansamuelson@proton.me)  
💼 [LinkedIn](https://linkedin.com/in/ryansamuelson18)  
🐙 Check out my repos below

---

*Builder. Problem-solver. The friend who shows up. Always learning.*
